...
import { PriorityActionItem } from '../../../hooks/home/useCarrierPriorityActions';
...
const PriorityActionCard = ({ item, loading = false }: Props) => {
      ...
      <View style={styles.leftContent}>
        ...
        <View style={styles.textBlock}>
          ...
          <Text style={styles.helper}>
            {item.count > 0 ? 'Open now' : 'No pending items'}
          </Text>
        </View>
      </View>
